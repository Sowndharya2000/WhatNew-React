...
export const SliderData = [
  {
     ...
     desc:"sofa designed to redefine the way you lounge. Made for trendy homes, this sofa features a modern design that also offers a breakthrough in space management.",
      cover: sofaSlide,
  },
  {
      id: 2,
      title: "50% Off For Your First Shopping",
    desc:"Phone can be used to play around with the perspective so that your pictures are out of the ordinary and mesmerising.",
      cover: phone08,
  },
  {
      id: 3,
      title: "50% Off For Your First Shopping",
     desc:"Headset is very broad, so a summary of the different types and some top-rated products for specific uses will help you narrow your audio.",
      cover: wireless01,
  },
  {
      id: 4,
      title: "50% Off For Your First Shopping",
      desc: "Smartwatches are small, wrist-worn computers that connect to your smartphone and offer additional features beyond timekeeping. They come in a variety of styles, from sporty to casual.",
      cover: watchSlide,
  },
];
